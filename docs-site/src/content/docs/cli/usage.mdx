---
title: CLI Usage
description: "Command-line access to every extraction feature — installation, global flags, extraction commands, embeddings, chunking, and API utilities."
---
...
- [Chunking & Embeddings](/guides/chunking-embeddings/) - Chunking, embeddings, and post-extraction processing
- [Plugin Development](/guides/plugins/) - Extend Kreuzberg functionality
