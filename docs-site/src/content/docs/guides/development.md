...
description: "Build, test, and debug Kreuzberg locally — task commands, the snippet system, and FFI debugging across the Rust core and language bindings."
---

Everything you need to build, test, and debug Kreuzberg locally. This guide assumes you've already followed the [Contributing Guide](/contributing/) to fork and clone the repo.
...
Code examples in the docs aren't inline — they're pulled from `docs/snippets/` via a snippet-include directive. This keeps examples testable and reusable across pages.
