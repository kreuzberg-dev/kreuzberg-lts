...
description: "Deploy Kreuzberg to Kubernetes — Helm chart, OCR configuration, permissions, resource limits, and health checks."
---
...
:::note[Permission denied on cache directory]
...
- [Docker Deployment](/guides/docker/) — container configuration and image variants
