...
description: "Integrate 146 LLM providers via liter-llm for VLM OCR, structured extraction, and provider-hosted embeddings — configuration and provider setup."
---
...
- [Advanced Features](/guides/chunking-embeddings/) — chunking, language detection, local embeddings
