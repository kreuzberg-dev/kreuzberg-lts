...
description: "Expose Kreuzberg over Model Context Protocol so any AI agent can extract documents, generate embeddings, and manage caches through standard tools."
---
