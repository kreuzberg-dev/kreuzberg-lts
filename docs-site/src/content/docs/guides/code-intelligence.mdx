...
description: "Parse and analyze source code with tree-sitter-language-pack — automatic language detection and structured analysis alongside raw text extraction."
---
...
- [Types Reference](/reference/types/#code-metadata-processresult) -- ProcessResult, StructureItem, CodeChunk, and related type definitions
