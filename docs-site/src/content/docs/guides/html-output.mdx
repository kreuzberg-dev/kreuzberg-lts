---
title: HTML Output
description: "Emit semantic HTML from extraction with kb-* classes — element mapping, custom class prefixes, and styling the rendered document tree."
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

:::note[Added in v4.8.1]
:::
...
- [Document Structure](/guides/output-formats/#document-structure) -- how Kreuzberg models document structure
