---
title: Architecture
description: "How Kreuzberg's Rust core, FFI bridges, and per-language bindings fit together, and why the core is written in Rust."
---
...
- [Plugin System](/concepts/plugin-system/) - extending Kreuzberg with custom extractors, OCR backends, and processors
