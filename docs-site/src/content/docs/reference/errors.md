...
description: "Kreuzberg error types, numeric codes, and cross-language error handling patterns."
---
...
- [Configuration Reference](/reference/configuration/) - Configuration options that affect error handling
- [Format Support](/reference/formats/) - Supported formats and their limitations
- [OCR Guide](/guides/ocr/) - OCR-specific error handling
