...
description: "WebAssembly API for Kreuzberg via wasm-bindgen: extraction functions and the WASM-compatible feature surface."
---
...
For LLM-powered extraction, use the native bindings ([Node.js](/reference/api-typescript/), [Python](/reference/api-python/), [Rust](/reference/api-rust/)) or the [HTTP API](/guides/llm-integration/) (`POST /extract-structured`) from your WASM application.
:::
...
See the [LLM Integration Guide](/guides/llm-integration/) for full details on server-side LLM features.
...
- [Quick Start Examples](/getting-started/quickstart/)
