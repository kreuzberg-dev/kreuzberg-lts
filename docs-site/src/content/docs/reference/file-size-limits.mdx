...
description: "Default file-size limits, how to configure them, and the errors raised when inputs exceed them."
---
...
- [Performance Tuning](/guides/api-server/#performance-tuning) - Advanced performance optimization
