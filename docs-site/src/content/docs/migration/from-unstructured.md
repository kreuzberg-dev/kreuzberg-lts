---
title: Migrating from Unstructured to Kreuzberg
description: "Map Unstructured.io endpoints, element types, and configuration to their Kreuzberg equivalents, with side-by-side code examples."
---
...
1. Explore Kreuzberg-specific features (hierarchy, per-page metadata, embeddings)
