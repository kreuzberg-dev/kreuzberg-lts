...
go get github.com/kreuzberg-dev/kreuzberg-lts/v4@v4.10.3
```
...
| `undefined: v4.ExtractFile` | This function was removed in v4.10.3. Use `ExtractFileSync` and wrap in goroutine if needed (see migration guide) |
...
- `task go:lint` – runs `gofmt` and `golangci-lint` (`golangci-lint` pinned to v4.10.3).
