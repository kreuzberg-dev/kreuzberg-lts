...
<div align="center" style="display: flex; flex-wrap: wrap; gap: 8px; justify-content: center; margin: 20px 0;">
  ...
  <a href="https://github.com/kreuzberg-dev/kreuzberg-lts/pkgs/container/kreuzberg-full">
...
go get github.com/kreuzberg-dev/kreuzberg-lts/v4@v4.10.4
```
...
| `undefined: v4.ExtractFile` | This function was removed in v4.10.4. Use `ExtractFileSync` and wrap in goroutine if needed (see migration guide) |
...
- `task go:lint` – runs `gofmt` and `golangci-lint` (`golangci-lint` pinned to v4.10.4).
