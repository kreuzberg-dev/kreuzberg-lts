...
| Named-entity recognition (GLiNER) | [`urchade/gliner_multi-v2.1`](https://huggingface.co/urchade/gliner_multi-v2.1), [`urchade/gliner_small-v2.1`](https://huggingface.co/urchade/gliner_small-v2.1), [`urchade/gliner_medium-v2.1`](https://huggingface.co/urchade/gliner_medium-v2.1), [`urchade/gliner_large-v2.1`](https://huggingface.co/urchade/gliner_large-v2.1), [`knowledgator/gliner-x-large`](https://huggingface.co/knowledgator/gliner-x-large) |
