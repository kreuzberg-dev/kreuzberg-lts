...
[![License](https://img.shields.io/pypi/l/kreuzberg-surrealdb)](https://github.com/kreuzberg-dev/kreuzberg-lts-surrealdb/blob/main/LICENSE)
...
For the complete API reference, embedding model options, chunking configuration, and database schema details, see the [kreuzberg-surrealdb README](https://github.com/kreuzberg-dev/kreuzberg-lts-surrealdb). For general SurrealDB usage, see the [SurrealDB docs](https://surrealdb.com/docs).
