...
impl JsTokenCounter {
    ...
    pub fn next_token(&self, category: JsPiiCategory, original: String) -> String {
        ...
        String::from("[unimplemented: TokenCounter.next_token]")
    }
...
pub fn embed_texts(texts: Vec<String>, config: Option<JsEmbeddingConfig>) -> Result<Vec<Vec<f64>>> {
    let config_core: kreuzberg::EmbeddingConfig = config.unwrap_or_default().into();
...
impl From<JsGlineBackend> for kreuzberg::GlineBackend {
    fn from(val: JsGlineBackend) -> Self {
        // This type has private fields; construct via kreuzberg::GlineBackend::new() directly.
        let _ = val;
        ::std::todo!("Use kreuzberg::GlineBackend::new() instead of From conversion")
    }
}
...
impl From<JsSegment> for kreuzberg::chunking::semantic::merge::Segment<'_> {
    fn from(val: JsSegment) -> Self {
        // This type has private fields; construct via kreuzberg::chunking::semantic::merge::Segment::new() directly.
        let _ = val;
        ::std::todo!("Use kreuzberg::chunking::semantic::merge::Segment::new() instead of From conversion")
    }
}
