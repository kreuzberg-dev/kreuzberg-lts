...
# alef:hash:feda2efb70450a093b10c2a027bf15081717522df45d2f80d4519ba11fffe807
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef
defmodule Kreuzberg.ElementType do  @moduledoc "Semantic element type classification."
  @type t ::
:title
          | :narrative_text
          | :heading
