...
# alef:hash:9c5d0ffcecc6dd13d2001cc9a450591e59cc63df4ffe5b0714c7a1aaeb5e4da6
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef
defmodule Kreuzberg.ChunkType do  @moduledoc "Semantic structural classification of a text chunk."
  @type t ::
:heading
          | :party_list
          | :definitions
