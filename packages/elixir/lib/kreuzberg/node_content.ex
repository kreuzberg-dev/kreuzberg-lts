...
# alef:hash:f5819abfe477ae716714a38078109db84e76fad7eb4eb4ee88e0a8d56ef80903
# To regenerate: alef generate
# To verify freshness: alef verify --exit-code
# Issues & docs: https://github.com/kreuzberg-dev/alef
defmodule Kreuzberg.NodeContent do  @moduledoc "Tagged enum for node content. Each variant carries only type-specific data."
  @type t :: term()
